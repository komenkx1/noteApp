...
import com.example.appnote.FileHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void newFile() {
        ...
        Toast.makeText(this, "Me-reset file", Toast.LENGTH_SHORT).show();
    }
    ...
    public void saveFile() {
        if (editTitle.getText().toString().isEmpty()) {
            ...
            Toast.makeText(this, "Menyimpan " + editTitle.getText().toString() + " file", Toast.LENGTH_SHORT).show();
        }
    }
